                  ...
                  Wrap(
                    ...
                    children: [
                      ...
                      _premiumPortalCard(
                        ...
                        details: 'Unified hospital operations, consent management, and data sharing.',
                        icon: Icons.local_hospital_rounded,
                        color: const Color(0xFF10B981),
                        target: const RoleLoginScreen(role: 'Hospital'),
                      ),
                      _premiumPortalCard(
                        context,
                        title: 'Admin Portal',
                        subtitle: 'Governance & Control',
                        details: 'System-wide monitoring, user approvals, and platform configuration.',
                        icon: Icons.admin_panel_settings_rounded,
                        color: const Color(0xFFEF4444),
                        target: const RoleLoginScreen(role: 'Admin'),
                      ),
                    ],
                  ),
