...
class _HospitalWebDashboardState extends State<HospitalWebDashboard> {
          ...
          Expanded(
            child: ListView(
              children: [
                ...
                _sidebarItem(2, Icons.event_note_rounded, 'Affiliated Bookings'),
                _sidebarItem(3, Icons.medical_services_rounded, 'Staff Directory'),
      ...
      child: Row(
        children: [
          ...
          const CircleAvatar(
            ...
            child: Icon(Icons.business_rounded, color: Color(0xFF1F2937), size: 20),
          ),
        ],
      ),
    );
  ...
  Widget _buildAnalytics(bool isDesktop) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader('Health Analytics Dashboard', 'Aggregated medical data for facility-level insights.'),
  ...
  Widget _inventoryStatus() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Diagnostics Tracking', style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 32),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(label, style: GoogleFonts.poppins(fontSize: 11, color: progress < 0.5 ? Colors.red : Colors.green)),
            ],
          ),
  ...
  Widget _patientDemographics() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Patient Inflow', style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
          const SizedBox(height: 32),
          Center(
            child: Container(
              width: 150,
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: _primaryColor.withOpacity(0.3), width: 15),
              ),
              child: Center(
                child: Text('78%', style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
              ),
            ),
          ),
          const SizedBox(height: 32),
          Text('Capacity utilized across all departments.', style: GoogleFonts.poppins(color: Colors.white60, fontSize: 13), textAlign: TextAlign.center),
        ],
      ),
    );
  }
  ...
  Widget _buildSharedReports(bool isDesktop) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader('Reports with Consent', 'Medical data shared by patients for diagnostic assistance.'),
        const SizedBox(height: 32),
        Container(
          decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(24)),
          child: ListView.separated(
            ...
            itemBuilder: (context, index) => ListTile(
              ...
              title: Text('Patient: XYZ-102${index + 1}', style: GoogleFonts.poppins(fontWeight: FontWeight.bold)),
  ...
  Widget _buildBookings(bool isDesktop) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSectionHeader('Referred Appointments', 'Linkages between facility care and diagnostic testings.'),
        const SizedBox(height: 32),
        GridView.builder(
          shrinkWrap: true,
          physics: const NeverScrollableScrollPhysics(),
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text('APPT-7${index+1}2', style: GoogleFonts.poppins(fontSize: 11, fontWeight: FontWeight.bold, color: _primaryColor)),
                    ),
                    const Icon(Icons.more_horiz),
                  ],
                ),
                const Spacer(),
                Text('Cardiac Follow-up', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.bold)),
                Text('Referred: 10 Jan 2026', style: GoogleFonts.poppins(fontSize: 12, color: Colors.grey)),
                const Spacer(),
                const Divider(),
                Row(
                  children: [
                    ...
                    Text('Patient MD-${index+1}', style: GoogleFonts.poppins(fontSize: 12)),
                  ],
                ),
              ],
            ),
  ...
  Widget _buildPlaceholder(String title) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(Icons.business_rounded, size: 60, color: _primaryColor.withOpacity(0.2)),
          const SizedBox(height: 16),
          Text('$title Feature is coming soon.', style: GoogleFonts.poppins(color: Colors.grey)),
        ],
      ),
    );
  }
